        ...
        <div className="mt-16 border-t border-stone-900/10 pt-8 sm:mt-10 lg:mt-12 lg:flex lg:items-center lg:justify-between">
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-stone-600 sm:w-56 text-xs sm:text-sm sm:leading-6"
